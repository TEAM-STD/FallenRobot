...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(text="☁️ ʟɪꜰᴇʟɪɴᴇ ☁️", callback_data="source_"),
    ],
]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="ᴜᴩᴅᴀᴛᴇs", url=f"https://t.me/lifelinesss"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                        ...
                        InlineKeyboardButton(
                            text="ʟɪꜰᴇʟɪɴᴇ", url="https://t.me/DEEPANSHU_WORLD"
                        ),
                    ],
                    [
